...
const BatchDownloadManager = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Batch Download Manager - YT Deluxe</title>
            ...
            <div className="space-y-8">
              ...
              <div className="text-center py-8">
                ...
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                  Process multiple YouTube videos simultaneously with comprehensive queue management, 
                  progress tracking, and bulk download capabilities.
                </p>
              </div>
