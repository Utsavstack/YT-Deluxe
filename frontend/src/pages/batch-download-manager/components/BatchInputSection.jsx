...
const BatchInputSection = ({ onAddUrls, onImportFromClipboard }) => {
 ...
 return (
  <div className="space-y-6">
   ...
   <div className="text-center">
    <h2 className="text-2xl font-bold text-foreground mb-2">Add Videos to Queue</h2>
    <p className="text-muted-foreground">
     Add multiple YouTube URLs to download them all at once
    </p>
   </div>
   {/* Clipboard Import */}
   <div className="glass-card p-4">
    <div className="flex items-center justify-between">
     <div className="flex items-center space-x-3">
      ...
      <div>
       <h3 className="font-semibold text-foreground">Import from Clipboard</h3>
       <p className="text-sm text-muted-foreground">
        Automatically detect YouTube URLs from your clipboard
       </p>
      </div>
     </div>
     <Button
   ...
   <div className="glass-card p-6">
    <div className="flex items-center space-x-2 mb-4">
     ...
     <h3 className="text-lg font-semibold text-foreground">Bulk URL Input</h3>
    </div>
    ...
    <div className="space-y-4">
     ...
     <div className="flex items-center justify-between">
      <span className="text-sm text-muted-foreground">
       {bulkUrls?.split('\n')?.filter(url => url?.trim() && isValidYouTubeUrl(url?.trim()))?.length} valid URLs detected
      </span>
      <Button
       variant="default"
   ...
   >
    <div className="text-center">
     ...
     <p className="text-muted-foreground mb-4">
      Or click to browse for a text file containing YouTube URLs
     </p>
     <Button
      variant="outline"
   ...
   <div className="glass-card p-6">
    <div className="flex items-center space-x-2 mb-4">
     ...
     <h3 className="text-lg font-semibold text-foreground">Add Single URL</h3>
    </div>
