   ...
   <div className="md:hidden">
    <div className="p-4">
     <div className="flex items-start space-x-3">
      ...
      <div className="flex-1 min-w-0">
       ...
       <p className="text-xs text-muted-foreground mb-2">
        {item?.channel} • {item?.views} {t("batchDownloadManager.views")} 
              </p>
     ...
     {isExpanded &&
       ...
       <Select
              label={t("batchDownloadManager.quality")}
       ...
       <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2">
         <Button
                  ...
                  disabled={!canMoveUp}
                  iconName="ArrowUp"> {t("batchDownloadManager.up")} 
         ...
         <Button
                  ...
                  iconName="ArrowDown"> {t("batchDownloadManager.down")} 
        ...
        <Button
                ...
                iconName="Trash2"> {t("batchDownloadManager.remove")} 
     ...
     <div className="flex items-center space-x-4">
      ...
      <div className="w-48">
       <Select
                ...
                value={item?.quality}
                onChange={(value) => onQualityChange(item?.id, value)}
                placeholder={t("batchDownloadManager.selectQuality")} />
