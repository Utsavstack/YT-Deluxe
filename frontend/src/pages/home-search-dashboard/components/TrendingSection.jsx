...
const TrendingSection = ({
  ...
  if (isLoading) {
    ...
    <div className="flex items-center space-x-2">
     ...
     <h2 className="text-xl font-bold text-foreground">{t("homeSearchDashboard.trendingVideos")}</h2>
    </div>
  ...
  return (
   ...
   <div className="flex items-center justify-between">
    ...
    <button
     ...
     <span>{t("homeSearchDashboard.updated")} {getTimeAgo(lastUpdated)}</span>
    </button>
   </div>
   ...
   {videos?.length === 0 && !isLoading ?
     ...
     <p className="text-muted-foreground"> {t("homeSearchDashboard.unableToLoadTrending")} 
