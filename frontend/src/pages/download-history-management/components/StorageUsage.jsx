...
const StorageUsage = ({ totalSize, availableSpace, itemCount }) => {const { t } = useTranslation();
   ...
   <div className="p-4">
    ...
    <div className="mb-4">
     <div className="flex items-center justify-between text-sm text-muted-foreground mb-2">
      <span>{t("downloadHistoryManagement.usedSpace")}</span>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
     <div className="text-center p-3 bg-accent/20 rounded-lg">
      ...
      <div className="text-sm text-muted-foreground">{t("downloadHistoryManagement.totalDownloaded")}</div>
     </div>
     ...
     <div className="text-center p-3 bg-accent/20 rounded-lg">
      ...
      <div className="text-sm text-muted-foreground">{t("downloadHistoryManagement.availableSpace")}</div>
     </div>
     ...
     <div className="text-center p-3 bg-accent/20 rounded-lg">
      ...
      <div className="text-sm text-muted-foreground">{t("downloadHistoryManagement.totalFiles")}</div>
     </div>
    </div>
    ...
    {usedPercentage >= 90 &&
      ...
      <div className="text-sm text-error"> {t("downloadHistoryManagement.storageSpaceIsRunning")} 
    ...
    {usedPercentage >= 75 && usedPercentage < 90 &&
      ...
      <div className="text-sm text-warning"> {t("downloadHistoryManagement.storageSpaceIsGetting")} 
