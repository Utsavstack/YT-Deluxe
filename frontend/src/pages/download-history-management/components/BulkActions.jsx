      ...
      {selectedItems?.length > 0 && (
        <div className="sticky bottom-6 z-[200] flex justify-center px-4 pointer-events-none mt-6">
          <motion.div
            ...
            className="bg-white/90 dark:bg-black/90 backdrop-blur-2xl border border-primary/20 dark:border-primary/20 rounded-[2rem] shadow-[0_16px_40px_-12px_rgba(0,0,0,0.3)] dark:shadow-[0_16px_40px_-12px_rgba(0,0,0,0.8)] pointer-events-auto w-full max-w-4xl"
          >
